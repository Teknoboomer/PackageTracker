...
namespace Tracker.Services.Dialogs
{
    //
    // The DialogService that is utilized by the Unity Container to
    ...
    public class DialogService : IDialogService
    {
        ...
        void ConfigureDialogWindowContent(IDialogWindow window, FrameworkElement dialogContent, IDialogAware viewModel, IDialogParameters parameters)
        {
            ...
            Prism.Common.MvvmHelpers.ViewAndViewModelAction<IDialogAware>(viewModel, d => d.OnDialogOpened(parameters));
        }
